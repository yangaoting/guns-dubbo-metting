...
@Slf4j
@Component
@Service(interfaceClass = OrderServiceApi.class,group = "default2017")
public class OrderServiceImpl2017 implements OrderServiceApi {
    ...
    public boolean isNotSoldSeats(String fieldId, String seats) {
        List<MoocOrder2017T> list = moocOrderTMapper.selectList(new EntityWrapper<MoocOrder2017T>().eq("field_id", fieldId));
