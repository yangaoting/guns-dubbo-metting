...
@Component
@Service(
        interfaceClass = AlipayServiceApi.class,
        mock = "com.stylefeng.guns.api.alipay.AplipayServiceMock")
public class DefaultAlipayServiceImpl implements AlipayServiceApi{
    ...
    private String trade_precreate(String orderId){
        ...
        String operatorId = "sys_operatorId";
...
//                dumpResponse(response);
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format("C:/Users/mayn/Desktop/qrcode/qr-%s.png",
    ...
    public AlipayResultVo getOrderStatus(String orderId) {
        ...
        log.debug("RpcContect attachment userId = " + userId);
        boolean paySuccess = trade_query(orderId);
        if(paySuccess){
    ...
    public boolean trade_query(String orderId) {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                paySuccess = orderServiceApi.paySuccess(orderId);
                break;
